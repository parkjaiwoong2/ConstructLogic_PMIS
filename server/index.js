...
app.get('/api/export/batch-approval-excel', async (req, res) => {
  ...
  try {
    ...
    const addSheet = (wb, sheetItems, tabName, cardNoForHeader, userProjectForHeader, totalCardForHeader, submitterName) => {
      ...
      const approvalStepWidth = 10;
      ws.columns = [
        { width: 10 }, { width: colProject }, { width: colItem }, { width: colDesc },
        { width: 11 }, { width: approvalStepWidth }, { width: approvalStepWidth }, { width: approvalStepWidth }, { width: approvalStepWidth },
      ];
      ...
      ws.getCell('D4').alignment = { vertical: 'middle' };
      ...
      ws.getCell('D5').alignment = { vertical: 'middle' };
      ...
      if (typeof totalVal === 'number') ws.getCell('G4').numFmt = '#,##0';
      ws.mergeCells('H4:I4');
      ws.mergeCells('H5:I5');
      ...
      if (sheetItems.length > 0) {
        ...
        ws.getCell(totalRow, 7).alignment = { horizontal: 'right', vertical: 'middle' };
