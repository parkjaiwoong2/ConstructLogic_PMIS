...
export default function RolePermissionsSuper() {
  ...
  const load = async () => {
    ...
    await nextTick();
    try {
      const data = await api.getAdminBatchRolePermissions(companyId || undefined, { allCompanies: true });
  ...
  return (
    <div className="admin-page">
      ...
      <p className="subtitle">
        회사별 관리자(role=admin)가 접근할 수 있는 메뉴를 설정합니다. 회사를 선택한 후 해당 회사 관리자 메뉴를 설정하세요.
      </p>
